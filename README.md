...
# Results 
Using pretrained models not only get high performance, but fastly attach convergence. In following figure, we show conditional and unconditional settings.![alt text](https://github.com/yaxingwang/Transferring-GANs/results/fid_conditional_1.png)
